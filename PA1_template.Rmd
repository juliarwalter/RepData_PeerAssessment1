...
# Plot 3
par(mfrow=c(2,1))
hist(tapply(data$steps, data$as.date, sum), main = "Histogram total number of steps taken each day", xlab = "Steps", ylim = c(0,50))
hist(tapply(data_3$steps, data_3$as.date, sum), main = "Histogram total number of steps taken each day- Imputed Data", xlab = "Steps", ylim = c(0,50), col = "blue")
dev.off()
```

## Are there differences in activity patterns between weekdays and weekends?

```{r convert date in weekday}
